...
namespace Content.Client._RedShooter.RDSVehicle;

public sealed class RdsVehicleSystem : RdsSharedVehicleSystem
{
    ...
    {
        base.Initialize();
        SubscribeLocalEvent<RdsVehicleComponent, AppearanceChangeEvent>(OnAppearanceChange);
        SubscribeLocalEvent<RdsVehicleComponent, MoveEvent>(OnMove);
    }

    private void OnAppearanceChange(Entity<RdsVehicleComponent> ent, ref AppearanceChangeEvent args)
    {
        if (args.Sprite == null
    ...
    private void OnMove(Entity<RdsVehicleComponent> ent, ref MoveEvent args)
    {
        SpritePos(ent);
    }

    private void SpritePos(Entity<RdsVehicleComponent> ent)
    {
